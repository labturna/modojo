    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      >
        <div className="flex space-x-2">
          <span className="bg-green-200 text-green-800 px-2 py-1 rounded-full text-sm">Easy: 77</span>
          <span className="bg-orange-200 text-yellow-800 px-2 py-1 rounded-full text-sm">Medium: 20</span>
          <span className="bg-red-200 text-red-800 px-2 py-1 rounded-full text-sm">Hard: 5</span>
        </div>
      </InfoCard>
    </div>
  );
