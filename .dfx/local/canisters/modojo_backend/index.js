...
export const canisterId = process.env.CANISTER_ID_MODOJO_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./modojo_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the modojo_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./modojo_backend.did.js")._SERVICE>}
 */
export const modojo_backend = createActor(canisterId);
