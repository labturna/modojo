...
export const canisterId = process.env.CANISTER_ID_MODOJO_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./modojo_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the modojo_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./modojo_frontend.did.js")._SERVICE>}
 */
export const modojo_frontend = createActor(canisterId);
